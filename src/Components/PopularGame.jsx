  ...
  return (
    <div className="my-10 px-4">
      <div className="tabs tabs-lifted">
        ...
        <div
          role="tabpanel"
          className="tab-content bg-accent lg:px-6 py-4 rounded-md rounded-r-xl rounded-b-xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"
        >
          {data && data.length > 0 ? (
